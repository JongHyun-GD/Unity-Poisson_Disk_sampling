...
public class MeshGenerator : MonoBehaviour
{
    [Range(10, 50)]
    public int k = 30;
    public int xSize, ySize, zSize, cellSize, maxDistance, minDistance;
    ...
    public void GenerateSampling()
    {
        ...
        points = pds.GetSampling(xSize, ySize, zSize, cellSize);
    }
    ...
    public void GenerateMesh()
    {
        ...
        for (int i = 0; i < points.Count; ++ i) {
            ...
            meshes.Add(Instantiate(genMesh, new Vector3(x, y, z), Quaternion.identity, this.transform));
        }
    }
